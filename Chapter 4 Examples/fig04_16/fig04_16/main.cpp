...
int main()
{
  ...
  //process 10 studnets using counter-controlled loop
  while(studentCounter <= 10)
	 {
		...
		if(result == 1)	//if result is 1.
		  ...
		  //increment atudentCounter so loop eventually terminates
  ...
  //determine whether more that eight students passed
  if(passes > 8)
